...
namespace Nethermind.JsonRpc.Test.Modules
{
    public class TraceModuleTests
    {
        ...
        public void Trace_replay_transaction()
        {
            ...
            string serialized = RpcTest.TestSerializedRequest(TraceModuleFactory.Formatters, module, "trace_replayTransaction", TestItem.KeccakC.ToString(true), "[\"stateDiff\", \"trace\"]");
        ...
        public void Trace_replay_block()
        {
            ...
            string serialized = RpcTest.TestSerializedRequest(TraceModuleFactory.Formatters, module, "trace_replayBlockTransactions", "latest", "[\"stateDiff\", \"trace\"]");
        ...
        public void Trace_block()
        {
            ...
            string serialized = RpcTest.TestSerializedRequest(TraceModuleFactory.Formatters,module, "trace_block", "earliest");
