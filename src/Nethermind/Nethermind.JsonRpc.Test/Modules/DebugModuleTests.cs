...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class DebugModuleTests
    {
        ...
        public void Get_trace()
        {
            ...
            DebugModule module = new DebugModule(NullLogManager.Instance, debugBridge);
            string response = RpcTest.TestSerializedRequest<IDebugModule>(DebugModuleFactory.Formatters, module, "debug_traceTransaction", TestItem.KeccakA.ToString(true), "{}");
        ...
        public void Get_trace_with_options()
        {
            ...
            DebugModule module = new DebugModule(NullLogManager.Instance, debugBridge);
            string response = RpcTest.TestSerializedRequest<IDebugModule>(DebugModuleFactory.Formatters, module, "debug_traceTransaction", TestItem.KeccakA.ToString(true), "{disableStack : true}");
