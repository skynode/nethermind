...
namespace Nethermind.Core.Json
{
    public class EthereumFormatterResolver : IJsonFormatterResolver
    {
        ...
        private static readonly IJsonFormatter[] Formatters = {
            ...
            new Utf8Json.Formatters.GenericDictionaryFormatter<long, ChainSpecJson.AuRaValidatorJson, Dictionary<long, ChainSpecJson.AuRaValidatorJson>>()
        };
...
//        
        ...
        private EthereumFormatterResolver()
        {
            CompositeResolver.RegisterAndSetAsDefault(
                new IJsonFormatter[] {new Utf8Json.Formatters.GenericDictionaryFormatter<long, ChainSpecJson.AuRaValidatorJson, Dictionary<long, ChainSpecJson.AuRaValidatorJson>>()},
